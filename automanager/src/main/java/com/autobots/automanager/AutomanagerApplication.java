...
public class AutomanagerApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		funcionario.getPerfis().add(PerfilUsuario.ROLE_FUNCIONARIO);
		...
		credencialFuncionario.setSenha(encoder.encode("123456"));
		...
		credencialFornecedor.setSenha(encoder.encode("123456"));
		...
		credencialCliente.setSenha(encoder.encode("123456"));
